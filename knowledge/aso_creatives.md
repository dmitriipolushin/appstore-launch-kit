...
- Оптимизация под 6.5" и 5.5" дисплеи обязательна
...
| Июнь 2025 | Индексация screenshot captions заявлена, но НЕ подтверждена контролируемым тестом |
...
- **Screenshot captions ranking weight**: индексирование НЕ подтверждено. Контролируемый тест ConsultMyApp: 36/64 фраз не ранжируются, 27/64 объясняются существующими метаданными, 1 спорная. Ценность подписей — конверсия
