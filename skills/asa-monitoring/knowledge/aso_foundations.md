...
| Июнь 2025 | Аномалия ранжирования; индексация screenshot captions НЕ подтверждена [3] |
...
- **Screenshot captions**: индексация не подтверждена. Единственный контролируемый тест (ConsultMyApp, 64 фразы) дал результат на уровне шума. Влияет на ранг косвенно — через CTR/CVR
...
- **Screenshot captions**: писать под конверсию. Ключи в подписях допустимы как дешёвая страховка, но строить на них стратегию нельзя — индексация не подтверждена.
