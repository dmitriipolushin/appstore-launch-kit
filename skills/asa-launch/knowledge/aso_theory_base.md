  ...
  root((ASO))
    ...
    Metadata
      ...
      Cross-localization
        ...
        1600 chars potential budget (10 локалей × 160)
...
| **metadata** | creatives | Screenshot captions — влияние на ранг не подтверждено, работают через CVR |
...
| Screenshot captions индексируются | — | Июнь 2025 | **Опровергнуто контролируемым тестом** |
...
| **Screenshot captions ranking delta** | metadata, creatives | Низкий | Сигнал НЕ подтверждён: ConsultMyApp 1/64 попадание | Считать закрытым, пока не появится чистый положительный тест |
