    ...
    <div style={{ width: W, height: H, background: GREEN, position: "relative", overflow: "hidden", fontFamily: F }}>
      <div style={{ position: "absolute", top: HEADLINE_TOP, left: TEXT_LR, right: TEXT_LR }}>
        <h1 style={{ fontSize: W * 0.11, fontWeight: 800, color: "#fff", lineHeight: 0.95, margin: 0 }}>
          Verstecktes<br />Gluten —<br />wir finden's.
        </h1>
        <div style={{
          ...
          <span style={{ fontSize: W * 0.038, fontWeight: 600, color: "rgba(0,0,0,0.5)", lineHeight: 1.2 }}>Produkte<br />geprüft</span>
        </div>
      </div>
      <Phone
    ...
    <div style={{ width: W, height: H, background: "#FFFFFF", position: "relative", overflow: "hidden", fontFamily: F }}>
      <div style={{ position: "absolute", top: HEADLINE_TOP, left: TEXT_LR, right: TEXT_LR }}>
        <h1 style={{ fontSize: W * 0.11, fontWeight: 800, color: DARK, lineHeight: 0.95, margin: 0 }}>
          Barcode oder<br />Foto vom<br />Etikett.
        </h1>
        <p style={{ fontSize: W * 0.055, fontWeight: 500, color: "rgba(0,0,0,0.5)", margin: `${W * 0.035}px 0 0`, lineHeight: 1.35 }}>
          KI erkennt Gluten direkt<br />aus dem Foto.
        </p>
      </div>
      <Phone
        src="/screenshots/ss2-result-de.png"
        alt="Scan"
        style={{
          position: "absolute",
          bottom: 0,
...
function Slide3() {
  const flags: Array<{ type: "error" | "warning"; text: string; sub: string; badge?: string }> = [
    { type: "error",   text: "Stark verarbeitet", badge: "NOVA 4", sub: "Täglicher Konsum summiert sich — der Körper kann es kaum verarbeiten." },
    { type: "error",   text: "Enthält Gluten",                     sub: "In deinen Allergenen hinterlegt." },
    { type: "warning", text: "Anfällig für Pestizidrückstände",    sub: "Bio ist hier sinnvoll." },
  ];
  return (
    <div style={{ width: W, height: H, background: "#FFFFFF", position: "relative", overflow: "hidden", fontFamily: F }}>
      <div style={{ position: "absolute", top: HEADLINE_TOP, left: TEXT_LR, right: TEXT_LR }}>
        <h1 style={{ fontSize: W * 0.11, fontWeight: 800, color: DARK, lineHeight: 0.95, margin: 0 }}>
          Jedes Produkt.<br />Vollständig<br />analysiert.
        </h1>
        <p style={{ fontSize: W * 0.055, fontWeight: 500, color: "rgba(0,0,0,0.45)", margin: `${W * 0.035}px 0 0`, lineHeight: 1.35 }}>
          Gluten, Pestizide, Verarbeitung —<br />alles auf einem Bildschirm.
        </p>
      </div>
      <Phone
        src="/screenshots/gluten-result.png"
        alt="Gluten result"
        objectPosition="top"
        style={{
          position: "absolute",
...
function Slide4() {
  return (
    <div style={{ width: W, height: H, background: "#FFFFFF", position: "relative", overflow: "hidden", fontFamily: F }}>
      <div style={{ position: "absolute", top: HEADLINE_TOP, left: TEXT_LR, right: TEXT_LR }}>
        <h1 style={{ fontSize: W * 0.11, fontWeight: 800, color: DARK, lineHeight: 0.95, margin: 0 }}>
          Alle deine<br />Bedürfnisse.<br />Ein Profil.
        </h1>
        <p style={{ fontSize: W * 0.055, fontWeight: 500, color: "rgba(0,0,0,0.5)", margin: `${W * 0.035}px 0 0`, lineHeight: 1.35 }}>
          Wähle Diäten und Allergene —<br />jeder Scan wird personalisiert.
        </p>
      </div>
      <Phone
        src="/screenshots/gluten-profile.png"
        alt="Profile"
        objectPosition="top"
        style={{
          position: "absolute",
...
function Slide5() {
  const rows = [
    { num: "100+",  label: "geprüfte Gluten-Inhaltsstoffe" },
    { num: "DE · AT · CH",  label: "DACH-Produkte vollständig erfasst" },
    { num: "Täglich", label: "neue Produkte aktualisiert" },
  ];
  return (
    <div style={{ width: W, height: H, background: "#FFFFFF", position: "relative", overflow: "hidden", fontFamily: F }}>
      <div style={{ position: "absolute", top: HEADLINE_TOP, left: TEXT_LR, right: TEXT_LR }}>
        ...
        <div style={{ marginBottom: W * 0.01 }}>
          ...
          <span style={{ fontSize: W * 0.072, fontWeight: 800, color: DARK, lineHeight: 1, display: "block" }}>Produkte geprüft.</span>
        </div>
        <p style={{ fontSize: W * 0.055, fontWeight: 500, color: "rgba(0,0,0,0.45)", margin: `${W * 0.04}px 0 ${W * 0.06}px`, lineHeight: 1.35 }}>
          Damit du immer weißt,<br />was du isst.
        </p>
...
const SCREENSHOTS = [
  ...
  { id: "g4", label: "Check",    component: Slide4 },
  { id: "g5", label: "CTA",      component: Slide6 },
];
...
export default function GlutenPage() {
  ...
  async function renderToBlobs(
    ...
    for (const size of sizes) {
      ...
      results.push({ filename: `${deviceLabel}-de-${slideNum}-${slideLabel}-${size.w}x${size.h}.png`, blob });
      await new Promise(r => setTimeout(r, 200));
    }
  ...
  async function exportAll() {
    ...
    try {
      ...
      a.download = `gluten-de-${new Date().toISOString().slice(0, 10)}.zip`;
      a.click();
    } finally {
      setExporting(null);
    }
      ...
      <div style={{ maxWidth: 1440, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <a href="/gluten/de" style={{ fontSize: 12, color: "#fff", fontWeight: 600, textDecoration: "none", background: GREEN, borderRadius: 6, padding: "4px 10px" }}>DE</a>
            <a href="/gluten/en" style={{ fontSize: 12, color: "#888", textDecoration: "none" }}>EN</a>
